This was a web-based platform developed to allow multiple participants to be involved in and play a same online virtual route choice experiments at the same time. The platform was developed based on Python and Django, and deployed on OpenShift.
